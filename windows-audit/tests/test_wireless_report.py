...
class WirelessReportTests(unittest.TestCase):
    def test_status_ssid_overrides_config_and_omits_psk(self):
        ...
        status = ET.fromstring('<Envelope xmlns:t="urn:types"><t:Status><t:SSID>Active-WiFi</t:SSID><t:BSSID>aa:bb:cc:dd:ee:ff</t:BSSID><t:SignalStrength>Good</t:SignalStrength></t:Status></Envelope>')
    ...
    def test_confidential_missing_data_is_explained_and_footer_is_safe(self):
        ...
        self.assertIn('Не са въведени при проверката', html)
